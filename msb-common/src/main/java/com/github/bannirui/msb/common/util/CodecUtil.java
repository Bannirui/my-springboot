...
public class CodecUtil {
    ...
    public static String encode(String str, String charset) {
        try {
            ...
            throw new ErrorCodeException(e, ExceptionEnum.PARAM_EXCEPTION, new Object[] {"CodecUtil.encode编码异常", str});
        }
    }
    ...
    public static String decode(String str, String charset) {
        try {
            ...
            throw new ErrorCodeException(e, ExceptionEnum.PARAM_EXCEPTION, new Object[] {"CodecUtil.decode解码异常", str});
        }
    }
