...
/**
 * {@link MMSSubscribeTemplate}的代理拦截
 */
@MsbPlugin(order = 0)
public class CatMMSMessageListenerInterceptor extends Interceptor {

    public CatMMSMessageListenerInterceptor(MethodInterceptor methodInterceptor) {
