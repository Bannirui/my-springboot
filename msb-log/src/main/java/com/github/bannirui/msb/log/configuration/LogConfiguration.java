...
/**
 * <ul>
 *     <li>{@link com.github.bannirui.msb.log.annotation.EnableMsbLog}中通过{@link org.springframework.context.annotation.Import}注解向容器中注入了{@link com.github.bannirui.msb.log.autoconfigure.EnableDynamicLogImportSelector}</li>
 *     <li>最终向容器中注入了当前类</li>
